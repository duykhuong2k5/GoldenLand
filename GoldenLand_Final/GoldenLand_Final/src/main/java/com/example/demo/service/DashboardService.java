...
public class DashboardService {
    ...
    public Map<String, Object> getDashboardData() {
     ...
     // --- Người dùng (users) mới ---
        List<Object[]> userData = dashboardRepository.countUsersByMonth();
        Map<Integer, Long> userMap = new LinkedHashMap<>();
        for (Object[] row : userData) {
            userMap.put(((Number) row[0]).intValue(), ((Number) row[1]).longValue());
        }
