...
//    @Override
//    public List<UserDTO> findNewUsers(int days) {
//        long millis = System.currentTimeMillis() - (long) days * 24 * 60 * 60 * 1000;
//        Date cutoff = new Date(millis);
//        List<User> users = userRepository.findByCreatedDateAfter(cutoff);
//        List<UserDTO> results = new ArrayList<>();
//        for (User u : users) {
//            if (u.getStatus() != null && u.getStatus() == 0) continue; // skip deleted
//            UserDTO dto = userConverter.convertToDto(u);
//            if (!u.getRoles().isEmpty()) dto.setRoleCode(u.getRoles().get(0).getCode());
//            results.add(dto);
//        }
//        return results;
//    }
