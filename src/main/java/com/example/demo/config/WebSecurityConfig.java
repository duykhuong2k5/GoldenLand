...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                // Đơn giản nhất: tắt CSRF toàn cục cho demo đăng ký/OTP
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/login",              // trang login (GET)
                                "/register",           // trang đăng ký (GET)
                                "/otp",                // ✅ TRANG NHẬP OTP (GET) — thêm dòng này để không bị redirect /login
                                "/auth/**",            // POST /auth/register, /auth/verify-otp, /auth/otp/send/email...
                                "/css/**", "/js/**", "/images/**", "/assets/**", "/webjars/**", "/favicon.ico",
                                "/error"               // tránh vòng lặp khi lỗi
                        ).permitAll()
