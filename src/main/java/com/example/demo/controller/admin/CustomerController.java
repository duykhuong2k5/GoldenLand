...
public class CustomerController {
    ...
    public ModelAndView getNews(@ModelAttribute CustomerSearchRequest customerSearchRequest,
        ...
        // ⚙️ Không dùng Pageable nữa, lấy toàn bộ danh sách
        List<CustomerDTO> customerList = customerService.findAll(conditions);

        ModelAndView mav = new ModelAndView("admin/customer/list");
        mav.addObject("customerList", customerList); // thay "page" bằng "customerList"
        mav.addObject("modelSearch", customerSearchRequest);
        mav.addObject("staffs", userService.getStaffs());
        mav.addObject("totalItem", customerList.size());
        return mav;
    }
