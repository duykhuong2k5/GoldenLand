...
// === [ADDED from File 2]
import com.example.demo.model.request.ChangePasswordRequest;   // [ADDED for changePassword]
// === [END ADDED]
...
public class CustomerAPI {
    ...
    // === [ADDED from File 2] — Customer Self-Service API ===

    /**
     * Cập nhật hồ sơ của khách hàng theo username
     * Dành cho người dùng đã đăng nhập (isAuthenticated)
     * Gọi từ: templates/web/customer/profile.html
     */
